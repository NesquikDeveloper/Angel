...
<a href="https://github.com/Bosta-Client/Client/actions/workflows/build.yml"><img src="https://img.shields.io/github/actions/workflow/status/Bosta-Client/Client/build.yml?branch=main&style=for-the-badge&logo=github&logoColor=white"/></a>&nbsp;
...
![GitHub all releases](https://img.shields.io/github/downloads/Bosta-Client/Client/total?label=Downloads&style=for-the-badge)&nbsp;

Simple and easy-to-use Minecraft client for 1.8.9 (and in future™, newer versions - the [multiversion branch](https://github.com/Bosta-Client/Client/tree/dev/multiversion) is being worked on).

[Website & Download](https://angel-client.github.io)&nbsp;&nbsp;
...
However, it does mostly work so you can download a preview from [here](https://github.com/Bosta-Client/Installer/releases).
...
Click [this fancy blue text](https://github.com/Bosta-Client/Client/projects/1) to see planned features.

If you want to suggest a feature, you can [create a new issue](https://github.com/Bosta-Client/Client/issues/new) or [ask on Discord](https://discord.gg/TSAkhgXNbK).
